...
class AuthoRegisterFormUnitTest(TestCase):
...
class AuthoRegisterFormIntegrationTest(DjangoTestCase):
    ...
    def test_username_field_max_length_should_be_150(self):
        ...
        url = reverse('authors:create')
        msg = 'Username must have laess than 150 characters.'
        response = self.client.post(url, data=self.form_data, follow=True)
        self.assertIn(msg, response.context['form'].errors.get('username'))
        self.assertIn(msg, response.content.decode('utf-8'))
    ...
    def test_password_field_have_lower_upper_case_letters_and_numbers(self):
        ...
        self.form_data['password'] = 'abC123@432'
        url = reverse('authors:create')
        response = self.client.post(url, data=self.form_data, follow=True)
    ...
    def test_password_and_password_confirmation_are_equal(self):
        ...
        self.form_data['password'] = 'abC123@432'
        self.form_data['password2'] = 'abC123@4324'
        url = reverse('authors:create')
        ...
        self.form_data['password'] = 'abC123@432'
        self.form_data['password2'] = 'abC123@432'
        url = reverse('authors:create')
        response = self.client.post(url, data=self.form_data, follow=True)
